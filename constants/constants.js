...
const ACTIVITY_CONSTANTS = {
  ADD_OPENING_STOCK: 'ADD_OPENING_STOCK',
  ADD_NEW_STOCK: 'ADD_NEW_STOCK',
  NEW_ORDER: 'NEW_ORDER',
  NEW_PRIMARY_ORDER: 'NEW_PRIMARY_ORDER',
  NEW_SECONDARY_ORDER: 'NEW_SECONDARY_ORDER',
  NEW_SECOND_PRIMARY_ORDER: 'NEW_SECOND_PRIMARY_ORDER',
  SUPER_STOCKIST_VISIT: 'SUPER_STOCKIST_VISIT',
  DISTRIBUTOR_VISIT: 'DISTRIBUTOR_VISIT',
  RETAIL_VISIT: 'RETAIL_VISIT',
};
